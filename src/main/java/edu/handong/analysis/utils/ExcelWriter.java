...
public class ExcelWriter {
	public static void WriteAFile1(ArrayList<ExcelType1> lines, String path) {
	...
	public static void WriteAFile2(ArrayList<ExcelType2> lines, String path) {
